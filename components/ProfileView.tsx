  ...
  return (
    <div className="p-8 animate-in slide-in-from-right duration-500">
      <div className="flex flex-col gap-2 mb-10">
        ...
        <div className="h-1 w-24 bg-gradient-to-r from-purple-600 via-white to-pink-600 rounded-full"></div>
      </div>
      ...
      <div className="mb-12">
        ...
        <div className="glass-panel border-white/10 rounded-[3rem] p-10 relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="inline-block px-4 py-1.5 glass-panel border-purple-600/30 rounded-full text-[8px] font-black text-purple-500 uppercase tracking-widest mb-6">
              Processing...
            </div>
            ...
            <button className="w-full mt-12 bg-white/5 border border-white/10 py-5 rounded-[2rem] text-[10px] font-black text-pink-600 uppercase tracking-widest hover:bg-pink-600/10 hover:border-pink-600/30 transition-all">
              Abort Session
            </button>
          </div>
        </div>
